...
The basic power analysis as described in the Vignette [Getting started](https://jeroendmulder.github.io/powRICLPM/articles/getting-started.html) can be extended to using bounded estimation, estimation with constraints over time, and the inclusion of measurement error variances. These extensions are described below.
